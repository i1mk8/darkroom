...
using Resources = darkroom.UI.resources.Resources;
...
{
    public BulletControllerTests() => Resources.ExtractAll();
    
    [TestMethod]
    public void AddBullet()
    {
        var map = new Map(50, 50, []);
        var processor = new BulletController(map);
        var player = new Player(map, 1f, 1f, 0.2f);
        var soundController = new SoundManager(player);
